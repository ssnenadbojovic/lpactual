...
var EFLenders_1 = require("../../lpClient/src/models/EFLenders");
var r = rdb();
...
module.exports = function (options) {
    ...
    var efLender = new EFLenders_1.EFLenders();
    ...
    //Update
    //*************************************************************
    app.get('/UpdateActive', function (req, res) {
        p.then(function (conn) {
    ...
    app.get('/UpdateLender', function (req, res) {
        p.then(function (conn) {
            r.table("Lenders").filter({
                id: req.body.id
            }).update({
    ...
    app.get('/UpdateLmi', function (req, res) {
        p.then(function (conn) {
            r.table("Lmis").filter({
                id: req.body.id
            }).update({
    ...
    app.get('/UpdateHem', function (req, res) {
        p.then(function (conn) {
            r.table("Hems").filter({
                id: req.body.id
            }).update({
    ...
    app.get('/getLmis', function (req, res) {
        console.log(req.query.id);
        p.then(function (conn) {
            //  ovde treba get. zbog plucka je stavljen filter
            r.table('Lenders').getAll(req.query.id).pluck('lmis').run(conn, function (err, data) {
                if (err) {
                    throw err;
                }
                res.setHeader('Content-Type', 'application/json');
    ...
    app.get('/getHems', function (req, res) {
        p.then(function (conn) {
            r.table('Hems').filter({
    ...
    app.get('/getMBP', function (req, res) {
        console.log(req.query.id);
        p.then(function (conn) {
            //  ovde treba get. zbog plucka je stavljen filter
            r.table('Lenders').getAll(req.query.id).pluck('mbp').run(conn, function (err, data) {
                if (err) {
                    throw err;
                }
                res.setHeader('Content-Type', 'application/json');
    ...
    //Delete
    //*************************************************************
    app.get('/deleteLenders', function (req, res) {
        try {
            p.then(function (conn) {
                r.table("Lenders").filter({
    ...
    //Add
    //*************************************************************
    app.post('/AddLmi', function (req, res) {
        p.then(function (conn) {
    ...
    app.post('/AddProduct', function (req, res) {
        p.then(function (conn) {
            r.table("Products").insert(req.body).run(conn, function (err, test) {
                if (err) {
                    console.log(err);
                }
            });
    ...
    app.post('/AddLender', function (req, res) {
        p.then(function (conn) {
            r.table("Lenders").insert(req.body).run(conn, function (err, test) {
                if (err) {
                    console.log(err);
                }
                else {
    ...
    app.get('/startcheck', function (req, res) {
    ...
    app.get('/AddMBP', function (req, res) {
        p.then(function (conn) {
            r.table("Lenders").filter({
                id: req.body.LenderId
            }).update({
